...
{
    public class ObrasWOMPageViewModel : ViewModelBase
    {
        ...
        private static ObrasWOMPageViewModel _instance;
        ...
        public static ObrasWOMPageViewModel GetInstance()
        {
            return _instance;
        }


        public ObrasWOMPageViewModel(INavigationService navigationService, IApiService apiService) : base(navigationService)
        {
